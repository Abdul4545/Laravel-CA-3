                ...
                <form action="" method="post" id="createJobForm" name="createJobForm">
                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <!-- <div class="mb-4">
                                <label for="description_no_editor" class="mb-2">Description<span class="req">*</span></label>
                                <textarea class="textarea" name="description" id="description_no_editor" cols="5" rows="5" placeholder="Description"></textarea>
                                <p></p>
                            </div> -->
...
<!-- <style>
    ...
    /* Custom height for specific textareas */
    #description,
    #benefits,
    #responsibility,
    #qualifications {
...
<script type="text/javascript">
    $("#createJobForm").submit(function (e) {
        e.preventDefault();
        // $('#benefits, #description, #responsibility, #qualifications').trumbowyg('destroy');

        let plainTextDescription = $('#description').trumbowyg('html').replace(/<[^>]*>/g, '');
        $('#description').val(plainTextDescription);

        let plainTextBenefits = $('#benefits').trumbowyg('html').replace(/<[^>]*>/g, '');
        $('#benefits').val(plainTextBenefits);

        let plainTextResponsibility = $('#responsibility').trumbowyg('html').replace(/<[^>]*>/g, '');
        $('#responsibility').val(plainTextResponsibility);

        let plainTextQualification = $('#qualifications').trumbowyg('html').replace(/<[^>]*>/g, '');
        $('#qualifications').val(plainTextQualification);
        ...
        if (errors.description) {
            $("#description").trumbowyg('destroy')
                .addClass('is-invalid')
                .siblings('p')
                .addClass('invalid-feedback')
                .html(errors.description)

            // $("#description_no_editor")
            // .addClass('is-invalid')
            // .siblings('p')
            // .addClass('invalid-feedback')
            // .html(errors.description);
